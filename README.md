...
- ID管理、ガバナンス、セキュリティ領域へ拡大する。
 
## 経歴
- CAEに関わるソフトのマニュアルを数百ページ作成し、判りやすい資料作成の方法を習得した。
...
- [VM バックアップ（ポリシー設定）]有償課金後に作成予定
- [VM の復元（ファイル回復 / VM全体）]有償課金後に作成予定
- [Blob のソフトデリート / スナップショット]
- [Storage アカウントの冗長性（LRS / GRS）の理解と設定]
