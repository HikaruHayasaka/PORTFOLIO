...
本ページでは監視対象を Storage アカウントに限定し、以下の理由から VM と NIC は対象外としている。
- VM（仮想マシン）  
...
<img src="../images/03-01-storage-01-scope.png" width="600">
...
<img src="../images/03-01-storage-02-metric-select.png" width="600">
...
<img src="../images/03-01-storage-03-multi-metric.png" width="600">

### 4-5 ダッシュボードで確認
1. 左メニュー →「ダッシュボード」を開く  
2. 追加したグラフがタイルとして表示されていることを確認  
   （※ 下部に配置されることが多いため、スクロールして確認）

<img src="../images/03-01-storage-04-dashboard.png" width="600">
